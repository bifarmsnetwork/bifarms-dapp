     ...
     <div className="el-main">
      ...
      <div className="tabs-container">
        <div className="tabs">
          ...
          <div className={toggleState === 2 ? "tab-pan is-active" : "tab-pan"} onClick={() => toggleTab(2)}>Upcoming [1]</div>
          <div className="line-perch"></div>
        ...
        <div className="list">
                  ...
                  <div className="amount-container">
                    <div className="amount color3">
                      ...
                      <div className="amount-value">
                        {" "}
                        1 BFS = 5.00 BUSD / 1 BUSD = 0.20 BFS
                      </div>
                    </div>
                  </div>
                  <div className="amount-container">
          ...
          {/* Item 1 End */}
          {/* upcoming rounds */}
          <div className={toggleState === 2 ? "item" : "no-item"}>
                ...
                <div className="top-div">
                  ...
                  <div className="amount-container">
                    <div className="amount color3">
                      ...
                      <div className="amount-value">
                        {" "}
                        1 BFS = 7.50 BUSD / 1 BUSD = 0.13 BFS
                      </div>
                    </div>
                  </div>
                  <div className="amount-container">
